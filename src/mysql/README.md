...
See [MySQL AWR in action](AWR_example.md) for an example of a performance report generated by the `mysql-awr` tool, highlighting specific optimization opportunities.
